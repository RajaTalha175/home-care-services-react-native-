...
const SearchList = ({ navigation }) => {
  ...
  const sendingData=route.params.sendingData;
  ...
  const [ReceivedData, setReceivedData] = useState(null);
    ...
    const fetchData = async () => {
        ...
        try {
          console.log(`Sending Data Is:${ip}Patient/PatientSearchNurses?serviceName=${sendingData.ServiceName}&patientID=${sendingData.PatientID}&NurseID=${sendingData.NurseID}`)
          const response = await fetch(`${ip}Patient/PatientSearchNurses?serviceName=${sendingData.ServiceName}&patientID=${sendingData.PatientID}&NurseID=${sendingData.NurseID}`);
                ...
                >
                  <TouchableOpacity 
                     onPress={() => {
                      ...
                      navigation.navigate('handoverprofile', { 
                      nurses: nurse,
                      AppointDetail: {
                        AppointDetail: sendingData,
                        ServiceName: data.ServiceName,
