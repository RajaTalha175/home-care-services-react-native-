  ...
  useEffect(() => {
    const fetchNurseSchedules = async () => {
      try {
        ...
        const apiUrl = `${ip}Search/NurseScheduleShow?NurseID=${nurses.NurseID}&dateFrom=${AppointDetail.AppointDetail.datefrom}&dateTo=${AppointDetail.AppointDetail.dateto}`;
    ...
    try {
      ...
      const userData = {
       PatientID:AppointDetail.PatientID,
        ...
        datefrom:AppointDetail.AppointDetail.datefrom,
        dateto:AppointDetail.AppointDetail.dateto,
        selectedSchedule: selectedSchedule
      };
      console.log('$$$$$$$$$$$$$');
      console.log('Recived Nurse is:', nurses);
console.log('Recived Data is:', AppointDetail);
console.log('For Sending Book:',userData);
