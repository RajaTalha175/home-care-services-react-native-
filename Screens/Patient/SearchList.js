...
const App = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (sendingData !== null) {
        try {
          const response = await fetch(`${ip}Search/PatientSearchNurses`, {
            method: 'POST',
            headers: {
            ...
            <View key={nurse.NurseID}>
              ...
              <View style={styles.statusRow}>
                ...
                >
                  <TouchableOpacity 
                     onPress={() => {
                      console.log('@@@@@@@@@@@@@@@@@@@@@@@@');
                      console.log('Nurse is:',nurse);
                      console.log('Details is:', {
                        AppointDetail: sendingData,
                        ServiceName: data.ServiceName,
                      });
                      
                      navigation.navigate('psearchlistprofile', { 
                      nurses: nurse,
                      AppointDetail: {
                        AppointDetail: sendingData,
                        ServiceName: data.ServiceName,
              ...
              <View style={styles.appointmentRow}>
                ...
                <View>
                  ...
                  <View style={styles.appointmentRow}>
                    <View style={styles.appointmentStatus1}>
                  <TouchableOpacity 
                     onPress={() => {
                      console.log('@@@@@@@@@@@@@@@@@@@@@@@@');
                    ...
                    navigation.navigate('individualrating',{nurse:nurse})
                  }
                     }
                  >
                    <Text style={{ color: 'black' }}>See Rating</Text>
                  </TouchableOpacity>
                  </View>
