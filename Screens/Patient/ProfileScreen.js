  ...
  useEffect(() => {
    ...
    const fetchPatientProfile = async () => {
      try {
        ...
        console.log('Searching Profile UserID IS:',UserID);
        const response = await fetch(`${ip}Patient/ShowPatientProfile?UserID=${UserID}`);
        console.log(UserID);
        ...
        console.log('Data:', data.Patient.UserID);
